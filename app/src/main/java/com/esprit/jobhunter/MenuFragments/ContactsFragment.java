...
import com.esprit.jobhunter.RecyclerViewsAdapters.ContactsAdapter;
...
public class ContactsFragment extends Fragment {
    ...
    String url = GlobalParams.url + "/getapprouvedjobappbyuserid/";
    RequestQueue queue;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        url+=((MainActivity)getActivity()).getConnectedUser().getId();
    ...
    private void getJsonArray() {
        ...
        System.out.println("URRRRLLLL: "+url);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            adapter = new ContactsAdapter(getActivity(), userList);
                            adapter.notifyDataSetChanged();
                            recyclerView.setAdapter(adapter);
                            adapter.notifyDataSetChanged();
                            progressBar1.setVisibility(View.GONE);
                            url = GlobalParams.url + "/getapprouvedjobappbyuserid/";
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
